// config.js — generated module split of the Spectrogramic Voxel Engine (behavior unchanged)
// Immutable defaults, colormap tables, camera presets, and HUD constants.
...
export const defaults = {
  ...
  keyboardControlTextFontSize: 13,
  keyboardControlTextX: 50,
  keyboardControlTextY: 96.5,
  logoVisible: true,
  logoX: 50,
  logoY: 5,
  logoSize: 5.5,
...
export const LOCAL_PRESET_KEY = "mirrored-waveform-cascade-presets-v1";
...
export const HUD_FREQUENCY_POINT_COUNT = 128;

export const HUD_FREQUENCY_MIN_HZ = 20;

export const HUD_FREQUENCY_MAX_HZ = 20000;

export const HUD_FREQUENCY_DB_MIN = -25;

export const HUD_FREQUENCY_DB_MAX = 0;

export const HUD_FREQUENCY_DB_STEP = 5;

export const HUD_ANALYSIS_FRAMES_PER_SECOND = 45;

export const HUD_MAX_ANALYSIS_FRAMES = 3600;

export const HUD_MIN_DB_RANGE = 80;

export const HUD_ATTACK_MS = 45;

export const HUD_RELEASE_MS = 180;

export const BASELINE_VIEWPORT_ASPECT = 16 / 9;

export const BASELINE_CAMERA_VERTICAL_FOV = 50;

export const DISTANCE_SPACING_EXPANSION = 0.06;
